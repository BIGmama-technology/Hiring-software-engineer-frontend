...
export default function ShareIcon({ textToCopy }: { textToCopy: string }){
    ...
    return (
        <Button className={"border-none bg-black"} variant="subtle"  onClick={handleClick}>{display}</Button>
    )
}